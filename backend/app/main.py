...
from app.models import user, ar_card, scan_history, redeem_item, redeem_history, login_history
...
# routers
from app.routers import admin_dashboard_route
...
app.include_router(admin_dashboard_route.router)
